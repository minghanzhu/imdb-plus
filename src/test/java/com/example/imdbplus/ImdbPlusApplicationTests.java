...
class ImdbPlusApplicationTests {
   ...
   */
  @Test
  void integrationTestUserSave() throws Exception {
  ...
  @Test
  void systemTestUserSave() throws Exception {
   ...
   */
  @Test
  void integrationTestUserSaveDuplicatedUsername() throws Exception {
    String testUsername = UUID.randomUUID().toString().replace("-", "") + "-testUsername";
    AccountSetting testAccountSetting = new AccountSetting(false, true);
    // Create a test user
    User testUser = new User(testUsername, "testEmail", testAccountSetting);
  ...
  @Test
  void systemTestUserSaveDuplicatedUsername() throws Exception {
